...
/**
 * The filter that filters only for less that specified value elements.
 * If element is equal or greater than specified as constructor value, then it will
 * be not added to result collection.
 *
 * @author Ruslan Khmelyuk
 * @version $Rev$
 * @since 2009-01-08 01:57
 */
public final class LessThan<_T extends Comparable> extends AbstractFilter<_T> {
