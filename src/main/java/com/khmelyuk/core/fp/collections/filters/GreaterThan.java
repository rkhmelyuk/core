...
/**
 * The filter that filters only for greater that specified value elements.
 * If element is equal or less than specified as constructor value, then it will
